          ...
          <div className="mt-4 lg:mt-0 lg:row-span-3">
            ...
            <form className="mt-10">
              ...
              <button
                ...
                onClick={addToCart}
                disabled={loading}
                className="text-white bg-indigo-600 mt-10 w-full border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Add to cart
              </button>
            </form>
